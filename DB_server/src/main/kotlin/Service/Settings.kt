...
@Serializable
data class Settings(val id: Int, val username: String, val birthday: String, val gender: Gender, val physicalCondition: PhysicalCondition, val caffeineUsage: CaffeineUsage, val alcoholUsage: AlcoholUsage)
